  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form id="edit-form" action={dispatch} className="flex flex-col gap-3 w-full">
        <Input className="px-10 bg-white" name="username" type="text" defaultValue={infos.username} placeholder="Username" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <Input className="px-10 bg-white" name="email" type="email" defaultValue={infos.email} placeholder="Email" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <Input className="px-10 w-full bg-white" name="password" type="password" defaultValue="" placeholder="Change Password" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
