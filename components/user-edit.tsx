  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <form id="edit-form" action={dispatch} className="flex flex-col gap-3 w-full">
        <Input className="px-10 bg-white" name="username" type="text" required errors={state?.fieldErrors.username} defaultValue={infos.username} placeholder="Username" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <Input className="px-10 bg-white" name="email" type="email" required errors={state?.fieldErrors.email} defaultValue={infos.email} placeholder="Email" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <Input className="px-10 w-full bg-white" name="password" type="password" required errors={state?.fieldErrors.password} defaultValue="" placeholder="Change Password" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <Input className="px-10 w-full bg-white" name="confirmPassword" type="password" required errors={state?.fieldErrors.confirmPassword} defaultValue="" placeholder="Confirm Password" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1 1 21.75 8.25Z"></path>
        </svg>} />
      </form>
    </div>
