    ...
    <div className="flex min-h-screen w-full py-32">
      <div className="flex flex-col items-center w-full gap-14">
        ...
        <form action={dispatch} className="flex flex-col gap-5 w-full">
          <Input className="px-10" name="email" type="email" defaultValue="" placeholder="Email" required errors={state?.fieldErrors?.email} icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <Input className="px-10" name="username" type="text" defaultValue="" placeholder="Username" required icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <Input className="px-10" name="password" type="password" defaultValue="" placeholder="Password" required errors={state?.fieldErrors?.password} icon={<svg data-slot="icon" fill="none" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
